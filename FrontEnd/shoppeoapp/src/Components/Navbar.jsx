            ...
            <Box>
                <Stack backgroundColor={"#F9F9F9"}>
                 ...
                 <Image marginLeft={"20%"}width={"60%"} src={shoppeo}/>
                  ...
                  <Box>
                     <Text marginTop={"1em"} >Become a Seller</Text>
                  </Box>
                  <Box 
                  //  marginLeft={"2%"}
                  marginLeft={"50px"}
                ...
                <Stack backgroundColor={"#A9D1E9"}>
                    <Grid width={"80%"} margin={"auto"}templateColumns='repeat(7, 1fr)' gap={7}>
                        ...
                        <GridItem w='80%' h='10' >Grocery</GridItem>
                         <GridItem className="dropdown" w='80%' h='10' > 
                         <Text className="dropbtn">Cloths</Text>
                         ...
                         <GridItem w='80%' h='10'  >Jewellery</GridItem>
                         <GridItem className="dropdown" w='80%' h='10' > 
                         <Text className="dropbtn">Footwear</Text>
                         <div class="dropdown-content">
                            <a href="#">Men</a>
                            <a href="#">Women</a>
                            <a href="#">Kids</a>
